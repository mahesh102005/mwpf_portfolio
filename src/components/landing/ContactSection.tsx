...
import { ArrowRight, Instagram, Mail, Menu } from "lucide-react";
  ...
  return (
    <section id="contact" className="py-12 md:py-24 px-4 bg-background flex items-center justify-center">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col min-h-[600px] md:min-h-[800px] p-8 md:p-16 justify-between">
          ...
          <div className="flex justify-between items-start w-full">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-black/5 md:bg-white/5 border border-black/10 md:border-white/10 backdrop-blur-md">
              ...
              <span className="text-xs font-medium tracking-widest uppercase text-black/70 md:text-white/70">Available to work</span>
            </div>
          ...
          {/* Center Content */}
          <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 my-12 md:my-0">
            ...
            >
              <Button 
                size="lg" 
                className="h-16 px-10 rounded-full bg-black text-white md:bg-white md:text-black hover:bg-zinc-800 md:hover:bg-zinc-200 border-4 border-black/10 md:border-white/10 shadow-[0_0_40px_-10px_rgba(0,0,0,0.3)] md:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] transition-all duration-300 group text-lg font-medium"
          ...
          <div className="hidden md:flex flex-col md:flex-row items-center justify-between gap-8 pt-8 border-t border-white/5">
